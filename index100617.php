...
if($menuname==''){$menuname='shop';$menuname2='ware';global $HotStr3; 
	$HotStr3='newyear';$HotStr3='love';;$HotStr3='easter';$HotStr3='love';$HotStr3='russianstyle';$HotStr3='cobaltnet';}////$HotStr3='cobaltnet';$menuname='shop';$menuname2='ware';$menuname3='teacof';
...
$menuenglish=array(
	...
	array("stoppard","Decorative plates","plate150","Decorative plates 150mm","plate200","Decorative plates 200mm","plate260","Decorative plates 260mm","decoplate","Decorative plates IPM","holder","Holder for plates"),//"vodka","Для водки","water","Для воды","martini","Для мартини","champagne","Для шампанского","glasses","Стеклянная посуда"
...
<a href="'.aPSID("$langstr/shop/ware/teacof/teacup/sortbycost0142").'" target="_self">
...
{$stroka='';
	...
	if(mysqli_num_rows($query1)>0){
		...
		mysqli_free_result($query1);	mysqli_free_result($query2);///	
	}
	echo "</td>";
	echo '</tr></table>';
...
function printsearch($searchline){
	...
	$echo.='<div id="scrollup"><img width="50px" alt="Прокрутить вверх";" src="/img/up.png"></div></td>';
	mysqli_free_result($queryz);mysqli_free_result($r);

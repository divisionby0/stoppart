...
if($menuname==''){$menuname='shop';$menuname2='ware';global $HotStr3; 
	$HotStr3='newyear';$HotStr3='love';;$HotStr3='easter';$HotStr3='love';$HotStr3='russianstyle';$HotStr3='cobaltnet';}
$menu=array(
	array("plates","Декоративные тарелки"),
	array("stand","Подставки"),
	array("contacts","Где купить"),
	array("conditions","Условия сотрудничества"),
	array("price","Скачать прайс лист")
);
$menuenglish=array(
	array("plates","Decorative plates"),
	array("stand","Stands"),
	array("contacts","Where to buy"),
	array("conditions","Conditions"),
	array("price","Download price")
);
...
for($i=0;$i<5;$i++){
	$menuLink=$menu[$i][0]; 
	if($menuLink=="stoppard") $menuLink="shop/stoppard/best";
	if($menuLink=="stands") $menuLink="shop/stands";
	
	$tekname=$menu[$i][1];
	if($language=="") $tekname=$menu[$i][1]; elseif($language=="en") $tekname=$menuenglish[$i][1];
	if($m2==$i) $strokas='<a href="'.aPSID($langstr.'/'.$menuLink.'/'.$sortstr).'" style="FONT-SIZE:19px;color:#FFFFFF;" ><B>'.my_strtoupper($tekname).'</B></a>';
	//$strokas='<font style="FONT-SIZE:19px;color:#FFFFFF;" ><b>'.my_strtoupper($tekname).'</b></font>';
	else $strokas='<a href="'.aPSID($langstr.'/'.$menuLink.'/'.$sortstr).'" style="FONT-SIZE:19px;FONT-weight:300px;color:#FFFFFF;" >'.my_strtoupper($tekname).'</a>';
	$am[$i]=$strokas;
};
...
<tr><td width="24%" height="1" style="padding-left:47px;"><img src="/empty.gif" width="150px" height="1px"></td>
<td width="56%"><img src="/empty.gif" width="100px" height="1px"></td>
<td width="20%" height="1" style="padding-right:47px;"><img src="/empty.gif" width="150px" height="1px"></td></tr>
...
<td class="top4">'.$am[3].'</a></td></tr></table></td>
<td class="top5">'.$am[4].'</a></td>
</tr></table>';
if($menuname=="search"){
	...
	while($row = mysqli_fetch_array($query1)){
		...
		if($counterofpage>$firstpiece and $counterofpage<=$lastpiece){
			...
			if($i<=3) $sti="padding-right:10px;";else $sti='';$Prov=ProverkaNal($id,'5');
				...
				<div>
				<input name="optionRadio'.$id.'" id="size1'.$id.'" value="150" type="radio"> 150мм
				<input name="optionRadio'.$id.'" id="size2'.$id.'" value="200" type="radio"> 200мм 
				<input name="optionRadio'.$id.'" id="size3'.$id.'" value="260" type="radio"> 260мм </div>
				';

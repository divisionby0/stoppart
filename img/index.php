...
array("sculptur","Скульптура","animal","Анималистическая","gofman","Гофманиана","genre","Жанровая"),
...
<HTML><HEAD><title>Императорский фарфор. Поволжье. Самара. Тольятти.</title>
		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%" align="right">
			...
			<tr><td height="42px">
				<table width="100%"  align="center" height="100%" cellspacing="0" cellpadding="0" border="0">
					<tr><td class="top" width="28%" style="padding-right: 17px; border-right: 1px solid black; text-align: right;"><a href="/kupon" target="_self">Купон на скидку</a></td>
...
//	<td style="color:gray;font-size:13px;background-color: #F6F6F4;vertical-align: middle;text-align:left;padding-left:10px;">Сортировать по наименованию, по цене. Отображать все товары, товары в наличии. </td>
	echo '
	<td style="color:gray;font-size:13px;background-color: #F6F6F4;vertical-align: middle;text-align:left;padding-left:10px;">Цены на сайте указаны со скидкой, предоставляемой по купону</td>
	</tr></table>
...
//PrintCatalog($page,$m3,$Uslovie,$Filter,$Sort);
  ...
  echo $a;
	...
	else //Описание товара
	{
		...
		$rowPicture=str_replace ("Не определен!","", $row['Picture']);
		$rowPicture=str_replace ("Не определен","", $rowPicture);
		$rowForm=str_replace ("Не определен!","", $row['Form']);
		$rowForm=str_replace ("Не определен","", $rowForm);
		$rowVid=$row['Vid'];
		...
		if($rowCollection!="")echo"<b>Коллекция:</b><br><i>$rowCollection</i><br><br>";
		if($rowForm!="")echo"<b>Форма:</b><br><i>$rowForm</i><br><br>";
		if($rowPicture!="")echo"<b>Рисунок:</b><br><i>$rowPicture</i><br><br>";
		if($rowVid!="")echo"<b>Тип фарфора:</b><br><i>$rowVid</i><br><br>";
		if($rowPerson!="")echo"<b>Персон:</b><br><i>$rowPerson</i><br><br>";
		if($rowPredmetov!="")echo"<b>Предметов:</b><br><i>$rowPredmetov</i><br><br>";
		echo"<b>Цена:</b><br><i>$newprice1</i><br><br>";
...
г. Уфа, ТРЦ Галерея Арт, ул. Чернышевского, 75, второй этаж, телефон: +7 (347) 266-58-86<br>
график работы с 10:00 до 22:00 без выходных<br><br>

г. Самара, ТРК "Вива Лэнд", пр. Кирова, 147, первый этаж, телефон: +7 (846) 277-03-86<br>
график работы с 10:00 до 22:00 без выходных<br><br>

г. Самара, ТЦ "Русь на Волге", Московское шоссе, 15б, первый этаж, телефон: +7 (846) 277-08-23<br>
график работы с 10:00 до 21:00 без выходных<br><br>

г. Тольятти, ТРЦ "Вега", ул. Юбилейная, 40, секция 144, рядом с кинотеатром<br>
график работы с 10:00 до 21:00 без выходных<br><br>

г. Тольятти, ТОЦ "Гранд Сити", Новый проезд, 3, первый этаж, телефон: +7 (8482) 52-54-50<br>
график работы с 10:00 до 19:00 с понедельника по пятницу <br><br>
...
&nbsp;&nbsp;&nbsp;Посетителям сайта ifarfor.ru предоставляется подарочный сертификат на скидку, действующий на все изделия, кроме высокохудожественных изделий, на ВХИ предоставляется скидка по купону в размере 10%.<br>
Достаточно сохранить подарочный сертификат на компьютер (Щелкните правой кнопкой на картинке, выберите пункт меню "Сохранить картинку как.."), распечатать его и предъявить при покупке в любом из фирменных магазинов "Императорский фарфор" в Поволжье:<br><br>
&nbsp;&nbsp;&nbsp;г. Уфа, ТРЦ Галерея Арт, ул. Чернышевского, 75, второй этаж, телефон: +7 (347) 266-58-86<br><br>

&nbsp;&nbsp;&nbsp;г. Самара, ТРК "Вива Лэнд", пр. Кирова, 147, первый этаж, телефон: +7 (846) 277-03-86<br>
&nbsp;&nbsp;&nbsp;г. Самара, ТЦ "Русь на Волге", Московское шоссе, 15б, первый этаж, телефон: +7 (846) 277-08-23<br><br>

&nbsp;&nbsp;&nbsp;г. Тольятти, ТРЦ "Вега", ул. Юбилейная, 40, секция 144, телефон: +7 (8482) 95-71-17<br>
...
'.$kusokkoda1.'<img src="/img/about.jpg"></td></tr><tr><td>
	...
	<tr>
		...
		<td width="25%"><a href="http://vk.com/ipmclub" target="_blank"><img src="/img/about4.jpg"><br>Новости Поволжского клуба любителей фарфора</a></td>
	</tr>
	<tr>
